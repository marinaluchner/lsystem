...
class App:
    ...
    def create_widgets(self):
        ...
        self.frameA.rowconfigure(list(range(16)), minsize=20) 
        ...
        # Preset values
        options = ["Tree", "Custom", "Bush", "Algea", "Wheat", ""]
        ...
        # Error button
        self.error_caption = ttk.Label(master=self.frameA, text="")
...
def invalid_chars(test_str):
    """Check string characters are all in the set of valid characters
